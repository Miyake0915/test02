DROP TABLE IF EXISTS datareceipt.mst_users;
CREATE TABLE datareceipt.mst_users(
    user_id         string(255)
  , sex             string(255)
...
INSERT INTO datareceipt.mst_users
VALUES
...
DROP TABLE IF EXISTS datareceipt.action_log;
CREATE TABLE datareceipt.action_log(
    session  string(255)
  , user_id  string(255)
  , action   string(255)
  , stamp    string(255)
...
INSERT INTO datareceipt.action_log
VALUES
